...
- [ ] 1. Utility modüllerini oluştur
  - [ ] 1.1 DateFormatter utility'sini oluştur
  ...
  - [ ]* 1.2 DateFormatter için unit testler yaz
  ...
  - [ ] 1.3 CurrencyFormatter utility'sini oluştur
...
- [ ] 2. Error handling altyapısını oluştur
  - [ ] 2.1 ErrorLogger singleton'ını implement et
...
- [ ] 3. Riverpod provider altyapısını oluştur (henüz kullanma)
  - [ ] 3.1 AuthStateProvider'ı oluştur
  ...
  - [ ] 3.2 ThemeStateProvider'ı oluştur
  ...
  - [ ] 3.3 UserDataProvider'ı oluştur
...
- [ ] 4. Feature flag sistemini ekle
  - [ ] 4.1 FeatureFlags configuration class'ını oluştur
...
- [ ] 5. Checkpoint - Phase 1 tamamlandı
...
- [ ] 6. Service dosyalarında _formatDate() migrasyonu
  - [ ] 6.1 worker_service.dart'ta _formatDate() kullanımını değiştir
  ...
  - [ ] 6.2 payment_service.dart'ta _formatDate() kullanımını değiştir
    - `_formatDate()` fonksiyonunu kaldır
    - Tüm kullanımları `DateFormatter.toIso8601Date()` ile değiştir
    - _Requirements: 2.1, 2.4, 2.11_
    - _Estimated time: 1 hour_
  
  - [ ] 6.3 attendance_service.dart'ta _formatDate() kullanımını değiştir
    - `_formatDate()` fonksiyonunu kaldır
    - Tüm kullanımları `DateFormatter.toIso8601Date()` ile değiştir
    - _Requirements: 2.1, 2.5, 2.11_
    - _Estimated time: 1 hour_
  
  - [ ] 6.4 advance_service.dart'ta _formatDate() kullanımını değiştir
    - `_formatDate()` fonksiyonunu kaldır
    - Tüm kullanımları `DateFormatter.toIso8601Date()` ile değiştir
    - _Requirements: 2.1, 2.6, 2.11_
    - _Estimated time: 1 hour_
  
  - [ ] 6.5 expense_service.dart'ta _formatDate() kullanımını değiştir
    - `_formatDate()` fonksiyonunu kaldır
    - Tüm kullanımları `DateFormatter.toIso8601Date()` ile değiştir
    - _Requirements: 2.1, 2.7, 2.11_
    - _Estimated time: 1 hour_
  
  - [ ] 6.6 report_service.dart'ta _formatDate() kullanımını değiştir
    - `_formatDate()` fonksiyonunu kaldır
    - Tüm kullanımları `DateFormatter.toIso8601Date()` ile değiştir
...
- [ ] 10. Checkpoint - Phase 2 tamamlandı
  - Tüm testlerin geçtiğini doğrula
...
- [ ] 11. ProviderScope ile app'i sar
  - [ ] 11.1 main.dart'ta ProviderScope ekle
    - `runApp(ProviderScope(child: MyApp()));` ile sar
    - flutter_riverpod import ekle
    - _Requirements: 3.1_
    - _Estimated time: 30 minutes_

- [ ] 12. Theme provider migrasyonu
  - [ ] 12.1 MyApp widget'ını ConsumerWidget'a dönüştür
    - `class MyApp extends ConsumerWidget` yap
    - `build(BuildContext context, WidgetRef ref)` signature kullan
    - _Requirements: 3.6_
    - _Estimated time: 1 hour_
  
  - [ ] 12.2 ThemeStateProvider'ı kullan
  ...
  - [ ] 12.3 Tema değiştirme fonksiyonlarını güncelle
...
- [ ] 13. Auth provider migrasyonu
  - [ ] 13.1 Bootstrap session'da AuthStateProvider kullan
  ...
  - [ ] 13.2 Router initialization'da AuthStateProvider kullan
  ...
  - [ ] 13.3 Worker session kontrolünü güncelle
...
- [ ] 15. Eski ValueNotifier'ları kaldır
  - [ ] 15.1 app_globals.dart'tan ValueNotifier'ları sil
  ...
  - [ ] 15.2 user_data_notifier.dart dosyasını sil
    - Dosyayı tamamen kaldır
    - Import referanslarını temizle
    - _Requirements: 5.8_
    - _Estimated time: 30 minutes_

- [ ] 16. Checkpoint - Phase 3 tamamlandı
  - Tüm testlerin geçtiğini doğrula
...
- [ ] 17. Cache mekanizması implementasyonu
  - [ ] 17.1 CachedFutureBuilder widget'ını oluştur
  ...
  - [ ] 17.2 WorkerListScreen'de CachedFutureBuilder kullan
    - Mevcut FutureBuilder'ı CachedFutureBuilder ile değiştir
    - Cache duration 5 dakika olarak ayarla
    - _Requirements: 6.5, 6.8_
    - _Estimated time: 1 hour_
  
  - [ ] 17.3 PaymentHistoryScreen'de CachedFutureBuilder kullan
    - Mevcut FutureBuilder'ı CachedFutureBuilder ile değiştir
    - Cache duration 5 dakika olarak ayarla
    - _Requirements: 6.6, 6.8_
    - _Estimated time: 1 hour_

- [ ] 18. ListView optimizasyonları
  - [ ] 18.1 WorkerListScreen ListView'ını optimize et
  ...
  - [ ] 18.2 PaymentHistoryScreen ListView'ını optimize et
