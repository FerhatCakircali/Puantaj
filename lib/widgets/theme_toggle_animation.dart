...
class _ThemeToggleAnimationState extends State<ThemeToggleAnimation>
  ...
  Widget build(BuildContext context) {
    ...
    final animationCenter = widget.center ?? Offset(size.width / 2, size.height / 2);
        ...
        ...List.generate(_numberOfStars, (i) {
          return AnimatedBuilder(
            ...
            builder: (context, child) {
              ...
              if (_controller.value >= 1.0 || _starOpacityAnims[i].value <= 0.01) {
              ...
              return Positioned(
                left: animationCenter.dx + _starPosAnims[i].value.dx - (_starSizes[i] / 2),
                top: animationCenter.dy + _starPosAnims[i].value.dy - (_starSizes[i] / 2),
                child: Opacity(
                  ...
                  child: starType == 0
                      ...
                      ? Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: starColor.withOpacity(_starOpacityAnims[i].value * 0.8),
                      ...
                      : starType == 1
                          ...
                          ? Transform.rotate(
                              angle: i * math.pi / 6 + (_controller.value * math.pi),
                              child: CustomPaint(
                          ...
                          : Transform.rotate(
                              angle: i * math.pi / 8 + (_controller.value * math.pi * 2),
                              child: Container(
                                width: _starSizes[i] * 1.5,
                                height: _starSizes[i] * 1.5,
                                decoration: BoxDecoration(
                                  color: starColor,
                                  borderRadius: BorderRadius.circular(_starSizes[i] * 0.3),
                                  boxShadow: [
                                    BoxShadow(
                                      color: starColor.withOpacity(_starOpacityAnims[i].value * 0.7),
              ...
              child: Opacity(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: (widget.goingToDark ? Colors.blue.shade200 : Colors.orange.shade300).withOpacity(0.3),
                        blurRadius: 10,
                        spreadRadius: 2,
                      ),
                    ],
