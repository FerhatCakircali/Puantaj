...
import '../mixins/worker_attendance_helpers.dart';
import 'payment_day_badge.dart';

/// Ödeme kartı widget'ı
class PaymentCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final notes = _getEffectiveNotes();
  ...
  String _getEffectiveNotes() {
    ...
    if (fullDaysFromDb > 0 || halfDaysFromDb > 0) {
      ...
      return '$totalDays gün için ödeme\n'
