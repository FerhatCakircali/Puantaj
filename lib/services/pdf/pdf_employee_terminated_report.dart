...
class PdfEmployeeTerminatedReportService {
            ...
            pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.SizedBox(height: 10),
                  pw.Text(
                    'NOT: Bu rapor çalışanın iş akdi sonlandırıldığında otomatik olarak oluşturulmuştur. '
                    'Raporda, çalışanın işe başladığı tarih (${dateFormat.format(employee.startDate)}) '
                    'ile işten çıkış tarihi (${dateFormat.format(DateTime.now())}) arasındaki tüm veriler gösterilmektedir.',
