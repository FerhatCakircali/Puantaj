            ...
            _employees
                .where(
                  (employee) =>
                      ...
                      employee.title.toLowerCase().contains(
                        query.toLowerCase(),
                      ),
                )
                .toList();
                            ...
                            if (pickedDate != null) {
                              ...
                              if (isDateChanged) {
                                ...
                                if (pickedDate.isAfter(employee.startDate)) {
                                  final hasRecords = await _employeeService
                                      .hasRecordsBeforeDate(
                                        employee.id,
                                        pickedDate,
                                      );
                      ...
                      onPressed: () async {
                        ...
                        if (_isStartDateChanged && _hasRecordsBeforeNewDate) {
                          ...
                          try {
                            ...
                            await _employeeService.deleteRecordsBeforeDate(
                              employee.id,
                              _selectedDate,
                            );
                ...
                onPressed: () async {
                  ...
                  try {
                    ...
                    final payments = await _paymentService
                        .getPaymentsByWorkerId(employee.id);
      ...
      try {
        ...
        if (_isEditing && _selectedEmployee!.startDate != _employee.startDate) {
          ...
          if (_employee.startDate.isAfter(_selectedEmployee!.startDate)) {
            ...
            final hasOldRecords = await _employeeService.hasRecordsBeforeDate(
        ...
        if (_isEditing) {
          ...
          await _employeeService.addEmployee(_employee);
        }
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ListView.separated(
                        ...
                        separatorBuilder:
                            (context, i) => const SizedBox(height: 12),
