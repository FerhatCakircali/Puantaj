...
class _AdminPanelScreenState extends State<AdminPanelScreen> {
  ...
  void _toggleThemeWithAnimation() async {
    ...
    final RenderBox? renderBox = _themeIconKey.currentContext?.findRenderObject() as RenderBox?;
    Offset? iconCenter;
    if (renderBox != null) {
      final iconPosition = renderBox.localToGlobal(Offset.zero);
      final iconSize = renderBox.size;
      iconCenter = iconPosition + Offset(iconSize.width / 2, iconSize.height / 2);
    }
          ...
          IconButton(
            ...
            onPressed: () async {
              ...
              if (hasSavedAccounts) {
                ...
                final success = await _authService.autoLoginWithFirstSavedAccount();
                ...
                if (success) {
                  ...
                  try {
                    ...
                    if (isAdmin) {
                      print('Admin hesabına giriş yapıldı, admin paneline yönlendiriliyor');
                      GoRouter.of(localContext).go('/admin_accounts');
                    } else {
                      print('Normal kullanıcı hesabına giriş yapıldı, ana sayfaya yönlendiriliyor');
                    ...
                    ScaffoldMessenger.of(localContext).showSnackBar(
                      SnackBar(
                        content: Text('${userData?['first_name']} ${userData?['last_name']} hesabına geçiş yapıldı'),
                    ...
                    Navigator.of(context).pushAndRemoveUntil(
                      MaterialPageRoute(builder: (_) => const AdminPanelScreen(initialTabIndex: 1)),
                      (route) => false
                    );
                  }
                  return;
                  ...
                  actions: [
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        final blockError = await _authService
