  ...
  Future<void> _register() async {
    ...
    try {
      ...
      if (error != null) {
        ...
        if (!mounted) return;
        // Kayıt başarılı olduğunda bilgilendirme mesajı göster
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
              'Hesabınız başarıyla oluşturuldu. Yönetici onayı bekleniyor. Yönetici ile iletişime geçiniz. (ferhatcakircali@gmail.com)',
            ),
            duration: Duration(seconds: 10), // Mesajın görünme süresi
          ),
        );
        
        // BUG FIX: Burada kullanıcıyı doğrudan giriş ekranına yönlendiriyoruz, otomatik giriş yapmıyoruz
        // authStateNotifier değerini güncelleme kısmını kaldırdık
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          PasswordField(
                            ...
                            labelText: 'Şifre',
                            // PasswordField zaten icon içeriyor, ona müdahale yok.
                          ),
                          const SizedBox(height: 16),
                          PasswordField(
