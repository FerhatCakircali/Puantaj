...
class LoginScreen extends StatefulWidget {
  ...
  const LoginScreen({
    super.key, 
    this.isFromAccountSwitch = false
  });
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  CredentialManager _credentialManager = CredentialManager();
  ...
  Future<void> _signIn() async {
    if (_usernameController.text.isEmpty || _passwordController.text.isEmpty) {
      if (mounted) {
        showGlobalSnackbar('Lütfen tüm alanları doldurunuz', backgroundColor: Colors.red);
      }
      return;
    }
