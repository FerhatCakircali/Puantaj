...
class _AttendanceScreenState extends State<AttendanceScreen> {
    ...
    try {
      ...
      if (selectedDate.isAtSameMomentAs(selectedToday)) {
        ...
        if (userId != null) {
          ...
          print('Kullanıcıya özel yevmiye durumu kaydedildi: $userAttendanceKey');
        }
  ...
  Future<void> _changeStatus(
    ...
    if (selectedDate.isAtSameMomentAs(selectedToday)) {
      print('Bugünün yevmiye durumu değiştirildi, bildirim durumunu hemen güncelliyorum');
      ...
      try {
        ...
        if (userId != null) {
          final userAttendanceKey = 'attendance_date_user_$userId';
          await prefs.setString(userAttendanceKey, today.toIso8601String());
          print('Kullanıcıya özel yevmiye durumu güncellendi: $userAttendanceKey');
        }
        ...
        print('Bildirim durumu başarıyla güncellendi (çalışan durumu değiştirme)');
