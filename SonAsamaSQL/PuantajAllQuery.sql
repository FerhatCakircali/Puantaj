...
BEGIN
  BEGIN
    -- Supabase Edge Function'a HTTP POST isteği gönder
    -- URL: Projenizin Supabase URL'i + /functions/v1/send-push-notification
    -- Authorization: Service role key (Supabase Dashboard > Settings > API)
...
-- Eski bildirimleri temizleyen fonksiyon (Migration)
-- 💡 Okunmuş ve bugünden eski bildirimleri siler (performans için)
...
-- ============================================
-- 7.6 NOTIFICATIONS REALTIME SETUP (Migration)
-- ============================================
